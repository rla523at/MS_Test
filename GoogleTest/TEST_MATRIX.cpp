...
GTEST_TEST(MATRIX, TRANSPOSE1) {
	RowMajorMatrix result(3, 2, { 1,2,3,4,5,6 });
	result.be_transpose();
...
GTEST_TEST(MATRIX, PLUS_ASSIGNMENT1) {
	RowMajorMatrix result(2, 2, { 1,2,3,4 });
...
GTEST_TEST(MATRIX, PLUS_ASSIGNMENT3) {
	RowMajorMatrix result(2, 3, { 1,2,3,4,5,6 });
	RowMajorMatrix m2(3, 2, { 1,3,4,5,5,6 });
	m2.be_transpose();
	result += m2;
...
GTEST_TEST(MATRIX, PLUS_ASSIGNMENT4) {
	RowMajorMatrix m1(2, 3, { 1,2,3,4,5,6 });
	RowMajorMatrix result(3, 2, { 1,3,4,5,5,6 });
	result.be_transpose();
	result += m1;
...
GTEST_TEST(MATRIX, PLUS_ASSIGNMENT6) {
	RowMajorMatrix result(2, 5, { 1.2345, 2.346345, 6.3262345, 8.5674567, 6.23452345, 2.53462, 6.432452345, 2.345345, 1.234563245, 7.3245345 });
	...
	EXPECT_TRUE(result.compare_with_finitie_precision(ref));// consdier round-off
}
GTEST_TEST(MATRIX, PLUS_ASSIGNMENT7) {
	RowMajorMatrix result(3, 5, { 1.2345, 2.346345, 6.3262345, 8.5674567, 6.23452345, 2.53462, 6.432452345, 2.345345, 1.234563245, 7.3245345,  789.45978, 74.5789123, 74.23541, 4.7894113, 7894.5134 });
