...
inline constexpr size_t DomainDim = 3;
...
#define X Polynomial<DomainDim>("x0")
#define Y Polynomial<DomainDim>("x1")
#define Z Polynomial<DomainDim>("x2")
...
GTEST_TEST(Polynomial, operator_addition_4) {
	const Polynomial<DomainDim> p1 = 0.0;
	const Polynomial<DomainDim> p2 = 0.0;
	const auto result = p1 + p2;

	const Polynomial<DomainDim> ref = 0.0;
	EXPECT_EQ(result, ref);
}
GTEST_TEST(Polynomial, operator_addition_5) {
	...
	const Polynomial<DomainDim> ref = 0;
	EXPECT_EQ(result, ref);
}
...
GTEST_TEST(Polynomial, operator_addition_9) {
	const Polynomial<DomainDim> p1 = 3;
	const auto p2 = X + 1;
	const auto result = p1 + p2;
...
GTEST_TEST(Polynomial, operator_substraction_4) {
	const Polynomial<DomainDim> p1 = 0;
	const auto p2 = X;
	const auto result = p1 - p2;
...
GTEST_TEST(Polynomial, operator_substraction_6) {
	...
	const Polynomial<DomainDim> p2 = 1;
	const auto result = p1 - p2;
...
GTEST_TEST(Polynomial, operator_multiplication_4) {
	const Polynomial<DomainDim> p1 = 3;
	const Polynomial<DomainDim> p2 = 2;
	const auto result = p1 * p2;

	const Polynomial<DomainDim> ref = 6;
	EXPECT_EQ(result, ref);
}
...
GTEST_TEST(Polynomial, operator_multiplication_11) {
	const Polynomial<DomainDim> p1 = 0;
	const Polynomial<DomainDim> p2 = 0;
	const auto result = p1 * p2;
...
GTEST_TEST(Polynomial, operator_call_1) {
	const Polynomial<DomainDim> m = 1;
...
GTEST_TEST(Polynomial, order_1) {
	const Polynomial<DomainDim> p = 0;
