...
public:
	...
	RowMajorMatrix(const size_t matrix_order, const MathVector& value);
	RowMajorMatrix(const size_t matrix_order, MathVector&& value);
...
private:
	RowMajorMatrix& direct_transpose(void);
